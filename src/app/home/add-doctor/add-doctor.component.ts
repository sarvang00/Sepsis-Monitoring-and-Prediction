...
export class AddDoctorComponent implements OnInit {
  ...
  onSubmit(){
    ...
    if(this.FORMDoctorADD.valid){
      ...
      this.Docadd.AddDoctor(this.FORMDoctorADD.value.Name,
        this.FORMDoctorADD.value.Age,
        this.FORMDoctorADD.value.DOB,
        this.FORMDoctorADD.value.BloodGroup,
        this.FORMDoctorADD.value.gender,
        this.FORMDoctorADD.value.UserName,
        this.url,
        this.FORMDoctorADD.value.Password,
        this.FORMDoctorADD.value.Aadhar,
        this.FORMDoctorADD.value.BankAccountNo,
        this.FORMDoctorADD.value.IFSC,
        this.FORMDoctorADD.value.Qualification,
        this.FORMDoctorADD.value.Specialization,
        this.FORMDoctorADD.value.Email,
        this.FORMDoctorADD.value.Mobile,
        this.FORMDoctorADD.value.EmergencyContactNo,
        this.FORMDoctorADD.value.FamilyContactPersonName,
        this.FORMDoctorADD.value.FamilyContactPersonRelationship,
        this.FORMDoctorADD.value.FamilyContactPersonNumber
        ).subscribe(data =>{
         alert(data["result"]);
